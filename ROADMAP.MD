...
## ✅ 2. Remote view & control   ·   hub 1.39.0 (+ agent, pending a signed release)
...
6. ~~**#2 Remote view & control**~~ — done, hub 1.39.0 (built ahead of #4 at the user's
   request; agent half pending a signed release; TURN server in `turn/`)

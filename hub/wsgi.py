...
# The fleet agent (agent/) runs on the hub machine too and reports it with full
# sensor data, so also starting the built-in local_logger here would
...
# hub on a box that has no agent, re-enable it with:
